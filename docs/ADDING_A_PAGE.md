...
## 1. Add the page to `public/assets/js/site-config.js`

Edit `window.SITE_PAGES` and add one object:
...
- Copy an existing inner page (e.g. `public/assessment.html` or `public/contact.html`).
...
## Optional: update `public/inc/header.html` and `public/inc/footer.html`
